...
public class RobotMap
{
    ...
    public static final int RIGHT_BACK_DRIVE = 9;
  ...
  //  public static final int LEFT_MIDDLE_DRIVE = 8;
    ...
    public static final int LEFT_ENC_OUT = 0;
     ...
     public static final int BUTTON_SENSOR = 5;
    ...
    public static final int SHOOTER_2 = 10; //Talon
    ...
    //LED Controler
    public static final int SPARK_CONTROLLER = 4;
